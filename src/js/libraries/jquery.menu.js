var MainMenu = function () {
  ...
  var mask =
    '<div id="menu-top-mask" style="height: 2px; background-color: transparent; z-index:1001;"/>';
  var timeOut;
  this.init = function (p) {
    ...
    $("ul.main-menu > li").click(function (event) {
      ...
      if (
        target.hasClass(settings.disabledClass) ||
    ...
    $("ul.main-menu > li > ul li").mouseenter(function (e) {
      ...
      parent.find("ul.active-sub-menu").each(function () {
        if ($(this) != $el) $(this).removeClass("active-sub-menu").hide();
      });
    ...
    toggleSubMenu = function (el) {
      ...
      var borderTop = parseInt(
        el.css("border-top-width").replace("px", ""),
        10,
      );
